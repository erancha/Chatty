...
local currentUserId = redis.call('GET', STACK_NAME .. ':userId(' .. currentConnectionId .. ')')
if currentUserId then
    -- Retrieve the chatId of the current connection id
    local chatId = redis.call('GET', STACK_NAME .. ':chatId(' .. currentConnectionId .. ')')
    ...
    redis.call('SREM', STACK_NAME .. ':connections(' .. chatId .. ')', currentConnectionId)
    return redis.call('SMEMBERS', STACK_NAME .. ':connections(' .. chatId .. ')')
else
